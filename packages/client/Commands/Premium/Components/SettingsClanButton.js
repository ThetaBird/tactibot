...
const { createPremiumClanSettingsMenu } = require("../PremiumDelivery");

class SettingsClanButton {
  /**
   * Creates an instance of SettingsClanButton.
  ...
  process = async () => {
    ...
    const delivery = createPremiumClanSettingsMenu(this.locale, data);
...
module.exports = { SettingsClanButton };
